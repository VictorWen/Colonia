...
public class World : MonoBehaviour, IWorld
{
    ...
    public void AddUnitEntityController(UnitEntity unitEntity, BaseUnitEntityController controller)
    {
        unitControllers.Add(unitEntity, controller);
    }
